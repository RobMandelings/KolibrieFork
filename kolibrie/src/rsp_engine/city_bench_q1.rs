...
fn rsp_ql_city_bench() {
    ...
    let iter = CsvGraphIter::from_path("streams/AarhusTrafficData158505.stream", traffic_mapper).unwrap();
    // CsvGraphIter::export_n3("streams/AarhusTrafficData158505.stream", "streams/outputs/output_traffic.n3", 5, traffic_mapper).expect("TODO: panic message");
