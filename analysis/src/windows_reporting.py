...
def plot_relative_mem_usage(df: pd.DataFrame, x_config: plot_configs.XConfig, folder_path):
    y_config = plot_configs.y_mem(False)
...
def windows_non_reporting():
    analysis_path = Path("../evaluation/windows_reporting/summary.csv")
    ...
    plot_relative_mem_usage(df, x_config, folder_path)
